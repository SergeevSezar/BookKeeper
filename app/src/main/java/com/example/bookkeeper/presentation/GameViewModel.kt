...
import com.example.bookkeeper.data.GameRepositoryImpl
...
import com.example.bookkeeper.domain.use_cases.GenerateQuestionUseCase
import com.example.bookkeeper.domain.use_cases.GetGameSettingsUseCase
...
class GameViewModel(application: Application): AndroidViewModel(application) {
    ...
    private fun updateProgress() {
        ...
        _enoughCount.value = countRightAnswers >= gameSettings.minCountOfRightAnswers
